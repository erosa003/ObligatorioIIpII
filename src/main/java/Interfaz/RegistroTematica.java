...
public class RegistroTematica extends javax.swing.JFrame {
    ...
    public RegistroTematica(Sistema sistema) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setName("botonregistrat"); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(repetido){
            JOptionPane.showMessageDialog(null, "ese nombre de tematica ya esiste", "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
        } else{
